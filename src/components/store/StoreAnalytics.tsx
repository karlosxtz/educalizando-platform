...
type Props = { storeId: string; metaPixelId?: string | null; googleAnalyticsId?: string | null };

export default function StoreAnalytics({ storeId, metaPixelId, googleAnalyticsId }: Props) {
