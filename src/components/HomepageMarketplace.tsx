  ...
  return (
    <main className="flex flex-col flex-1 pb-16 sm:pb-20">
      ...
      <section className="order-1 border-b border-violet-100 bg-white px-4 py-3 sm:px-6 lg:px-8" aria-label="Buscar materiais na homepage">
        <div className="mx-auto max-w-7xl"><SearchBar /></div>
      </section>
      ...
      <section className="order-4 mx-auto max-w-7xl px-4 py-7 sm:px-6 sm:py-10 lg:px-8" aria-labelledby="home-categorias">
      ...
      <section className="order-9 mx-auto max-w-7xl px-4 py-7 sm:px-6 sm:py-10 lg:px-8" aria-labelledby="home-calendario">
