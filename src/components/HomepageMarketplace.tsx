...
export default function HomepageMarketplace({
  ...
  return (
    <main className="flex flex-col flex-1 pb-16 sm:pb-20">
      ...
      <section className="order-4 mx-auto max-w-[1440px] px-4 py-9 sm:px-6 sm:py-12 lg:px-10" aria-labelledby="home-categorias">
