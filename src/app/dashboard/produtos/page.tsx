...
import { 
  ...
  FileText, Video, BookOpen, HelpCircle, Layers, Loader2, AlertTriangle, AlertCircle 
} from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 font-medium">
            Cadastre e gerencie suas apostilas em PDF, e-books, simulados e videoaulas com o Wizard guiado.
          </p>
        </div>
