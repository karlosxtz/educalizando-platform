          ...
          {activeTab === 'login' ? (
            ...
            <div className="space-y-6">
              <div className="text-center space-y-3">
                ...
                />
                <h1 className="text-2xl font-black text-slate-900">Portal do Afiliado</h1>
                <p className="text-xs text-slate-600">
                  Entre na sua conta de afiliado e acompanhe suas vendas e comissões.
                </p>
              </div>
              ...
              <div className="text-center pt-4 border-t border-slate-100 text-xs text-slate-600">
                ...
                <Link href="/afiliados/cadastro" className="text-brand-navy font-bold hover:underline">
