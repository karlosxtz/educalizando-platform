...
export default function ThemeDefault(props: StoreThemeProps) {
  const { 
    store, 
    products, 
    filteredProducts, 
        ...
        {store.author_bio && (
          <section className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left">
            {store.author_image_url ? (
              ...
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-slate-100 flex items-center justify-center text-slate-300 shadow-inner flex-shrink-0">
                <Sparkles className="w-10 h-10" />
              </div>
            )}
            <div className="space-y-3 flex-1">
              <h3 className="text-xl font-black text-slate-900">Sobre o Autor</h3>
                ...
                <>
                  ...
                  <div className="sticky bottom-0 -mx-5 sm:-mx-6 -mb-5 sm:-mb-6 mt-2 border-t border-slate-200 bg-white/95 p-4 backdrop-blur">
                    ...
                    <button
                      ...
                      className={`min-h-12 px-3 py-3 ${btnRadius} font-extrabold text-xs sm:text-sm text-slate-700 bg-slate-100 shadow-sm flex items-center justify-center gap-2 active:scale-95 transition-transform`}
                    >
                      <ShoppingBag className="w-4 h-4" /> Carrinho
                    </button>
                    <button
                      onClick={handleBuyNow}
                      className={`min-h-12 px-3 py-3 ${btnRadius} font-extrabold text-xs sm:text-sm text-white shadow-md flex items-center justify-center gap-2 active:scale-95 transition-transform`}
                      style={{ backgroundColor: primaryColor }}
                    >
